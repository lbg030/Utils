...
# XXX: Top View 전용
# defect_label = {'top_hole' : 0}

# for keys in defect_label.keys():
    # img_path = f"/home/lbg030/luna/data/Laser/{keys}" #XXX: Bottom View 전용
img_path = f"/Users/gwonsmpro/Desktop/edited_train/1" #XXX: Top View 전용
